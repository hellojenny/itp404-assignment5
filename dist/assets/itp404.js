...
define('itp404/controllers/artists', ['exports', 'ember'], function (exports, _ember) {
	exports['default'] = _ember['default'].Controller.extend({
		...
		// 		var id = this.get('id');
		// 		this.transitionToRoute('artists.artist', id);
		// 	}
		// }
	});
});
...
define("itp404/templates/artists", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template((function () {
    var child0 = (function () {
      var child0 = (function () {
        return {
          ...
          statements: [["content", "artist.name", ["loc", [null, [4, 45], [4, 60]]], 0, 0, 0, 0]],
          locals: [],
          templates: []
        };
      })();
      return {
        ...
        statements: [["block", "link-to", ["artists.artist", ["get", "artist.id", ["loc", [null, [4, 34], [4, 43]]], 0, 0, 0, 0]], [], 0, null, ["loc", [null, [4, 6], [4, 72]]]]],
        locals: ["artist"],
        templates: [child0]
      };
    })();
    return {
      ...
      statements: [["block", "each", [["get", "model.artists", ["loc", [null, [3, 9], [3, 22]]], 0, 0, 0, 0]], [], 0, null, ["loc", [null, [3, 1], [5, 10]]]], ["content", "outlet", ["loc", [null, [7, 0], [7, 10]]], 0, 0, 0, 0]],
      locals: [],
      templates: [child0]
    };
  })());
...
define("itp404/templates/artists/artist", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template((function () {
    ...
    return {
      ...
      statements: [["content", "model.artists.name", ["loc", [null, [1, 16], [1, 38]]], 0, 0, 0, 0], ["content", "model.songs.length", ["loc", [null, [1, 43], [1, 65]]], 0, 0, 0, 0], ["block", "each", [["get", "model.songs", ["loc", [null, [2, 8], [2, 19]]], 0, 0, 0, 0]], [], 0, null, ["loc", [null, [2, 0], [4, 9]]]], ["content", "outlet", ["loc", [null, [5, 0], [5, 10]]], 0, 0, 0, 0]],
      locals: [],
      templates: [child0]
    };
  })());
...
define("itp404/templates/components/song-item", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template((function () {
    ...
    return {
      ...
      statements: [["content", "song.title", ["loc", [null, [1, 8], [1, 22]]], 0, 0, 0, 0], ["block", "if", [["get", "isPricey", ["loc", [null, [1, 131], [1, 139]]], 0, 0, 0, 0]], [], 0, null, ["loc", [null, [1, 125], [1, 242]]]], ["block", "if", [["get", "isPopular", ["loc", [null, [1, 249], [1, 258]]], 0, 0, 0, 0]], [], 1, null, ["loc", [null, [1, 243], [1, 356]]]], ["content", "song.price", ["loc", [null, [2, 8], [2, 22]]], 0, 0, 0, 0], ["content", "song.playCount", ["loc", [null, [2, 37], [2, 55]]], 0, 0, 0, 0]],
      locals: [],
